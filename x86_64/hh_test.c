...
extern Memb_func* memb_func;
 ...
 "setdata_hh_test", _hoc_setdata,
 "rates_hh_test", _hoc_rates,
 "vtrap_hh_test", _hoc_vtrap,
 0, 0
};
#define vtrap vtrap_hh_test
...
#define _gth 0
#define htau_hh_test _thread1data[0]
#define htau _thread[_gth]._pval[0]
#define hinf_hh_test _thread1data[1]
#define hinf _thread[_gth]._pval[1]
#define mtau_hh_test _thread1data[2]
#define mtau _thread[_gth]._pval[2]
#define minf_hh_test _thread1data[3]
#define minf _thread[_gth]._pval[3]
#define ntau_hh_test _thread1data[4]
#define ntau _thread[_gth]._pval[4]
#define ninf_hh_test _thread1data[5]
#define ninf _thread[_gth]._pval[5]
#define usetable usetable_hh_test
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "gl_hh_test", 0, 1e+09,
 "gkbar_hh_test", 0, 1e+09,
 "gnabar_hh_test", 0, 1e+09,
 "usetable_hh_test", 0, 1,
 0,0,0
};
 ...
 "minf_hh_test", &minf_hh_test,
 "hinf_hh_test", &hinf_hh_test,
 "ninf_hh_test", &ninf_hh_test,
 "mtau_hh_test", &mtau_hh_test,
 "htau_hh_test", &htau_hh_test,
 "ntau_hh_test", &ntau_hh_test,
 "usetable_hh_test", &usetable_hh_test,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 7);
 	...
 	ivoc_help("help ?1 hh_test /home/mechuser/github/record/x86_64/hh_test.mod\n");
...
static int  _f_rates ( _threadargsprotocomma_ double _lv ) {
  ...
  if ( _lv > 400.0 ) {
     printf ( "too large v ( v=%g ) is detected at t = %g\n" , _lv , t ) ;
     }
   else if ( _lv < - 250.0 ) {
     printf ( "too small v ( v=%g ) is detected at t = %g\n" , _lv , t ) ;
     }
